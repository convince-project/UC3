...
public:
    ...
    void GetBestDance([[maybe_unused]] const std::shared_ptr<dance_interfaces::srv::GetBestDance::Request> request,
...
private:
    ...
    rclcpp::Service<dance_interfaces::srv::GetBestDance>::SharedPtr m_getBestDanceService;
