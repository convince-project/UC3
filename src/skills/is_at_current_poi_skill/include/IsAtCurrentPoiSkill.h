...
private:
	...
	std::shared_ptr<rclcpp::Node> nodeGetCurrentPoiForNavigation;
	std::shared_ptr<rclcpp::Client<scheduler_interfaces::srv::GetCurrentPoi>> clientGetCurrentPoiForNavigation;
