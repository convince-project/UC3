...
#include "CheckIfFirstPoiSkillSM.h"
...
class CheckIfFirstPoiSkill
{
public:
	CheckIfFirstPoiSkill(std::string name );
    ~CheckIfFirstPoiSkill();
...
private:
	...
	std::string m_name;
	CheckIfFirstPoiSkillCondition m_stateMachine;
