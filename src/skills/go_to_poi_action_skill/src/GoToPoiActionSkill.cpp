...
void GoToPoiActionSkill::result_callback(const  rclcpp_action::ClientGoalHandle<navigation_interfaces::action::GoToPoi>::WrappedResult & result)
{
  ...
  switch (result.code) {
    ...
    case rclcpp_action::ResultCode::ABORTED:
      ...
      m_stateMachine.submitEvent("NavigationComponent.GoToPoi.AbortedResultResponse", data);
      RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "NavigationComponent.GoToPoi.AbortedResultResponse");
      break;
    case rclcpp_action::ResultCode::CANCELED:
      RCLCPP_ERROR(m_node->get_logger(), "Goal was canceled");
      m_stateMachine.submitEvent("NavigationComponent.GoToPoi.CancelResult", data);
      RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "NavigationComponent.GoToPoi.CancelResult");
      break;
    default:
