...
private:
	...
	std::shared_ptr<rclcpp::Node> nodeIsAllowedToTurnBack;
	std::shared_ptr<rclcpp::Client<turn_back_manager_interfaces::srv::IsAllowedToTurnBack>> clientIsAllowedToTurnBack;
	std::shared_ptr<rclcpp::Node> nodeGetString;
	std::shared_ptr<rclcpp::Client<blackboard_interfaces::srv::GetStringBlackboard>> clientGetString;
