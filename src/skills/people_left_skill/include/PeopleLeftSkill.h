...
private:
	...
	std::shared_ptr<rclcpp::Node> nodeResetCounters;
	std::shared_ptr<rclcpp::Client<turn_back_manager_interfaces::srv::ResetCounters>> clientResetCounters;
	std::shared_ptr<rclcpp::Node> nodeStopTourTimer;
	std::shared_ptr<rclcpp::Client<time_interfaces::srv::StopTourTimer>> clientStopTourTimer;
	std::shared_ptr<rclcpp::Node> nodeStopPoiTimer;
	std::shared_ptr<rclcpp::Client<time_interfaces::srv::StopPoiTimer>> clientStopPoiTimer;
	std::shared_ptr<rclcpp::Node> nodeReset;
	std::shared_ptr<rclcpp::Client<scheduler_interfaces::srv::Reset>> clientReset;
