...
#include "ReloadBtSchedulerSkillSM.h"
...
class ReloadBtSchedulerSkill
{
public:
	ReloadBtSchedulerSkill(std::string name );
    ~ReloadBtSchedulerSkill();
...
private:
	...
	std::string m_name;
	ReloadBtSchedulerSkillAction m_stateMachine;
