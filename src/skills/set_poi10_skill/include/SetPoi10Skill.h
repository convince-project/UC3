...
private:
	...
	std::string m_name;
	SetPoi10SkillAction m_stateMachine;
	...
	std::shared_ptr<rclcpp::Node> nodeSetPoiFromPlanner;
	std::shared_ptr<rclcpp::Client<scheduler_interfaces::srv::SetPoi>> clientSetPoiFromPlanner;
