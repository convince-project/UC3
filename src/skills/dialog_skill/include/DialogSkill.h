...
private:
	...
	std::shared_ptr<rclcpp::Node> nodeGetCurrentLanguage;
	std::shared_ptr<rclcpp::Client<scheduler_interfaces::srv::GetCurrentLanguage>> clientGetCurrentLanguage;
	...
	std::shared_ptr<rclcpp::Node> nodeGetState;
	std::shared_ptr<rclcpp::Client<dialog_interfaces::srv::GetState>> clientGetState;
	std::shared_ptr<rclcpp::Node> nodeEnableDialog;
	std::shared_ptr<rclcpp::Client<dialog_interfaces::srv::EnableDialog>> clientEnableDialog;
