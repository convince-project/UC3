...
private:
	...
	std::shared_ptr<rclcpp::Node> nodeIncreaseTurnBacksCounter;
	std::shared_ptr<rclcpp::Client<turn_back_manager_interfaces::srv::IncreaseTurnBacksCounter>> clientIncreaseTurnBacksCounter;
	std::shared_ptr<rclcpp::Node> nodeSetString;
	std::shared_ptr<rclcpp::Client<blackboard_interfaces::srv::SetStringBlackboard>> clientSetString;
