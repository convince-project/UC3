      ...
      if (wait_succeded) {                                                                   
          ...
          if (futureResult == rclcpp::FutureReturnCode::SUCCESS) 
          {
              ...
              if( response->is_ok == true) {
                  ...
                  data.insert("language", response->language);
...
void DialogSkill::tick( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::TickActionAction::Request> request,
...
void DialogSkill::halt( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::HaltActionAction::Request> request,
