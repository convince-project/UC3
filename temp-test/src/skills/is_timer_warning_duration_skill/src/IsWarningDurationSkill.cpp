...
bool IsWarningDurationSkill::start(int argc, char*argv[])
{
	...
	std::cout << "IsWarningDurationSkill::start";
...
void IsWarningDurationSkill::tick( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::TickConditionCondition::Request> request,
