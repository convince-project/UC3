...
bool IsMaximumDurationSkill::start(int argc, char*argv[])
{
	...
	std::cout << "IsMaximumDurationSkill::start";
...
void IsMaximumDurationSkill::tick( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::TickConditionCondition::Request> request,
