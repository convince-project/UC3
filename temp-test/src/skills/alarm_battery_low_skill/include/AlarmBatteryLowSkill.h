...
public:
	...
	void topic_callback_readStatus(const sensor_msgs::msg::BatteryState::SharedPtr msg);
...
private:
	...
	rclcpp::Subscription<sensor_msgs::msg::BatteryState>::SharedPtr m_subscription_readStatus;
