...
#include <bt_interfaces_dummy/msg/actioncondition_response.hpp>
...
#include <bt_interfaces_dummy/srv/tick_actioncondition.hpp>
#include <bt_interfaces_dummy/srv/halt_actioncondition.hpp>
...
public:
	...
	void tick( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::TickActionCondition::Request> request,
...
private:
	...
	std::string m_name;
	SayWarningDurationSkillActionCondition m_stateMachine;
	std::atomic<Status> m_tickResult{Status::undefined};
	rclcpp::Service<bt_interfaces_dummy::srv::TickActionCondition>::SharedPtr m_tickService;
