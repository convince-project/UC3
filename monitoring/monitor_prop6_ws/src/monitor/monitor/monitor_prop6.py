...
class ROSMonitor_monitor_prop6(Node):
	...
	def __init__(self,monitor_name,log,actions):
		...
		self.topics_info['/camera_out']={'package': 'sensor_msgs.msg', 'type': 'Image'}
		self.topics_info['clock']={'package': 'builtin_interfaces.msg', 'type': 'Time'}
		self.config_subscribers['/camera_out']=self.create_subscription(topic='/camera_out',msg_type=Image,callback=self.callback_camera_out,qos_profile=1000)
