...
bool GoToPoiActionSkill::start(int argc, char*argv[])
{
	...
	m_haltService = m_node->create_service<bt_interfaces::srv::HaltCondition>(m_name + "Skill/halt",
...
void GoToPoiActionSkill::tick( [[maybe_unused]] const std::shared_ptr<bt_interfaces::srv::TickCondition::Request> request,
...
void GoToPoiActionSkill::halt( [[maybe_unused]] const std::shared_ptr<bt_interfaces::srv::HaltCondition::Request> request,
    [[maybe_unused]] std::shared_ptr<bt_interfaces::srv::HaltCondition::Response> response)
{
    std::lock_guard<std::mutex> lock(m_requestMutex);
