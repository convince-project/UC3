...
bool TimerComponent::start(int argc, char*argv[])
{
    ...
    *m_timerActive = false;
    ...
    m_startTimerService = m_node->create_service<timer_interfaces::srv::StartTimer>("/TimerComponent/StartTimer",  
                                                                                std::bind(&TimerComponent::StartTimer,
                                                                                this,
                                                                                std::placeholders::_1,
                                                                                std::placeholders::_2));
    m_isTimerActiveService = m_node->create_service<timer_interfaces::srv::IsTimerActive>("/TimerComponent/IsTimerActive",  
...
void TimerComponent::IsTimerActive([[maybe_unused]] const std::shared_ptr<timer_interfaces::srv::IsTimerActive::Request> request,
                std::shared_ptr<timer_interfaces::srv::IsTimerActive::Response>      response) 
{
...
void TimerComponent::StartTimer([[maybe_unused]] const std::shared_ptr<timer_interfaces::srv::StartTimer::Request> request,
                std::shared_ptr<timer_interfaces::srv::StartTimer::Response>      response) 
{
    std::lock_guard<std::mutex> lock(m_mutex);
    if (*m_timerActive) {
